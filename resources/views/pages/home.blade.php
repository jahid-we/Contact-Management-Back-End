...
@section('content')
    <nav class="navbar nav-color sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            <a class="navbar-brand" href="/"
                style="color: rgb(255, 0, 200); font-weight: bold; font-size: 1.7rem; font-family: 'Arial', sans-serif;">
                C <span style="font-size: 40px ; text-decoration: underline" >M</span>  S
            </a>
    ...
    <section class=" pb-10 banner-body">
        <div class="container  pt-2">
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                    <h2 class=" fw-bold mb-3">Simple. Easy. Fast. </h2>
                    <p class="lead text-muted mb-4">Save Your Time & Save Your Contact By Using This Software.</p>
                    <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary me-2 mb-2 mb-sm-0"
                            href="{{ url('/userLogin') }}">Add Contact</a>
    ...
    <footer class="py-5 bg-light">
        <div class="container text-center pb-5 border-bottom">
            <a class="navbar-brand" href="/"
                style="color: rgb(255, 0, 123); bac font-weight: bold; font-size: 2.2rem; font-family: 'Arial', sans-serif;">
                C <span style="font-size: 90px ; text-decoration: underline">M</span> S
            </a>
        ...
        <div class="mb-5"></div>
        <div class="container">
            <p class="text-center">All rights reserved © Jahid Hasan </p>
        </div>
    </footer>
@endsection
